            ...
            <div class="modal-body">
                ...
                <div class="feedback">
                    <div class="rating">
                        ...
                        <label id="5" onclick="rate(5)" for="rating-5"></label>
                        <input type="radio" name="rating" id="rating-4">
                        <label id="4" onclick="rate(4)" for="rating-4"></label>
                        <input type="radio" name="rating" id="rating-3">
                        <label id="3" onclick="rate(3)" for="rating-3"></label>
                        <input type="radio" name="rating" id="rating-2">
                        <label id="2" onclick="rate(2)" for="rating-2"></label>
                        <input type="radio" name="rating" id="rating-1">
                        <label id="1" onclick="rate(1)" for="rating-1"></label>
